...
const javascript = {
  ...
  use: [{
    loader: 'babel-loader',
    options: { presets: ['react'] }, // this is one way of passing options
  }],
};

/*
 This is our postCSS loader which gets fed into the next loader. I'm setting it up in it's own
 variable because its a didgeridog
 */
...
const config = {
  entry: {
    ...
    App: './src/index.js',
    vendor: './src/vendor.js', // ['react', 'babel-polyfill', 'react-dom'],
  },
